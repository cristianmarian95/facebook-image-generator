...
<body>
  ...
  <main class="container main">
    ...
    <form action="actions/takeads.php?action=edit&id=<?php echo $a->id; ?>" method="post">
      <div class="form-group">
        <label for="code">HTML Code (<font color="red">250x150 or 250x250</font>)</label>
        <textarea class="form-control" name="code" id="code" style="height: 250px;"><?php echo $a->code; ?></textarea>
      </div>
